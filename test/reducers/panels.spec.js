...
test('panels =>', (expect) => {
  ...
  expect.test('::Toggle toolbar', (expect) => {
    expect.deepEqual(
      panels({toolbar: false}, toggleToolbar()),
      {toolbar: true},
      'Should toggle toolbar to true',
    );
    expect.deepEqual(
      panels({toolbar: true}, toggleToolbar()),
      {toolbar: false},
      'Should toggle toolbar to false',
    );
    expect.end();
  });
  ...
  expect.test('::Toggle sidebar', (expect) => {
    expect.deepEqual(
      panels({sidebar: false}, toggleSidebar()),
      {sidebar: true},
      'Should toggle sidebar to true',
    );
    expect.deepEqual(
      panels({sidebar: true}, toggleSidebar()),
      {sidebar: false},
      'Should toggle sidebar to false',
    );
    expect.end();
  });
  ...
  expect.test('::Toggle framebar', (expect) => {
    expect.deepEqual(
      panels({framebar: false}, toggleFramebar()),
      {framebar: true},
      'Should toggle framebar to true',
    );
    expect.deepEqual(
      panels({framebar: true}, toggleFramebar()),
      {framebar: false},
      'Should toggle framebar to false',
    );
    expect.end();
  });
